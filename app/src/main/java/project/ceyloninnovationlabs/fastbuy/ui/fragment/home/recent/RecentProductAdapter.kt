package project.ceyloninnovationlabs.fastbuy.ui.fragment.home.recent
...
class RecentProductAdapter : PagingDataAdapter<Product, RecyclerView.ViewHolder>(RECENT_COMPARATOR) {

    companion object {
        private val RECENT_COMPARATOR = object : DiffUtil.ItemCallback<Product>() {
