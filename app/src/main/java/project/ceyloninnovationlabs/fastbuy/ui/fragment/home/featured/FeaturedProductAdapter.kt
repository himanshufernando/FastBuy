package project.ceyloninnovationlabs.fastbuy.ui.fragment.home.featured
...
import project.ceyloninnovationlabs.fastbuy.databinding.ListItemMainBinding


class FeaturedProductAdapter : PagingDataAdapter<Product, RecyclerView.ViewHolder>(FEATURED_COMPARATOR) {

    companion object {
        private val FEATURED_COMPARATOR = object : DiffUtil.ItemCallback<Product>() {
